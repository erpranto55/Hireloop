...
export default function Features() {
  return (
    <section className="relative overflow-hidden py-28 md:py-36">
      ...
      {/* Main Glow */}
      <div className="absolute left-1/2 top-0 h-37.5 w-62.5 -translate-x-1/2 bg-violet-600/10 blur-[180px]" />

      {/* Secondary Glow */}
      <div className="absolute left-1/2 top-1/2 h-31.25 w-75 -translate-x-1/2 -translate-y-1/2 bg-indigo-500/5 blur-[220px]" />
        ...
        <div className="mt-20 grid gap-x-10 gap-y-12 md:grid-cols-2 lg:grid-cols-4">
          {features.map((feature) => {
            ...
            return (
              ...
              >
                {/* Icon */}
                <div className="flex h-16 w-16 shrink-0 items-center justify-center rounded-2xl border border-white/10 bg-white/5 backdrop-blur-xl transition-all duration-300 group-hover:border-violet-500/40 group-hover:bg-white/10">
                  <Icon
                    size={24}
